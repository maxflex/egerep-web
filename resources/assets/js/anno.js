...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Anno = Anno = (function() {
	  ...
	  Anno.prototype.showOverlay = function() {
	    ...
	    if ($('.anno-overlay').length === 0) {
	      $('.main').append($e = this.overlayElem().addClass('anno-hidden'));
	      return setTimeout((function() {
	...
	exports.AnnoButton = AnnoButton = (function() {
	  ...
	  AnnoButton.prototype.buttonElem = function(anno) {
	    return $("<button class='button-green'></button>").html(this.textFn(anno)).addClass(this.className).click((function(_this) {
	      return function(evt) {
